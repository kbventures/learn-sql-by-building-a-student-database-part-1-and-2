...
--
-- Name: majors_courses majors_courses_course_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: kmb
--

ALTER TABLE ONLY public.majors_courses
    ADD CONSTRAINT majors_courses_course_id_fkey FOREIGN KEY (course_id) REFERENCES public.majors(major_id);
...
--
-- Name: students students_major_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: kmb
--
