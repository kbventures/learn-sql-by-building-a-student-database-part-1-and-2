...
echo -e "\nAll courses names whose first letter is before 'D' in the alphabet:"
...
echo -e "\nFirst name, last name, and GPA of students who have no selected a major and either their first name begins with 'D' or they have a GPA greater than 3.0:"
...
echo -e "\nAverage GPA of all students rounded to two decimal please:"

echo "$($PSQL "SELECT ROUND(AVG(gpa), 2) FROM STUDENTS;")"

echo -e "\nMajor ID, total number of students in a column named 'number_of_students', and average GPA rounded to two decimal places in a column name 'average_gpa', for each major Id in teh students table having a student count greater than 1:"
